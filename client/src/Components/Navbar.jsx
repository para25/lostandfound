...
import { Button, Menu, MenuItem, Stack, Drawer, IconButton, List, ListItem, ListItemText } from '@mui/material';
        ...
        <List>
          {token ? (
            <>
              ...
              <ListItem button component={Link} to="/LostItems">
                <ListItemText primary="Lost Items" />
              </ListItem>
              <ListItem button component={Link} to="/FoundItems">
                <ListItemText primary="Found Items" />
              </ListItem>
              <ListItem button component={Link} to="/postitem">
                <ListItemText primary="Post Item" />
              </ListItem>
              <ListItem button component={Link} to="/mylistings">
